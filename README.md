...
本仓库采用 [PolyForm Noncommercial 1.0.0](LICENSE)：**不允许商用**。

- **可以**：个人学习、业余项目、教学科研、非营利组织自用；可以改、可以自己部署给非商业团队用。
- **不可以**：出售本软件、做成收费服务 / SaaS、捆绑进商业产品，或以本软件开展营利性业务。营利公司内部使用也需另行授权。
- **商用授权**：写信到 [404243800@qq.com](mailto:404243800@qq.com)

完整条款见 [`LICENSE`](LICENSE)。数据文件 `data/` 和超管密码不属于开源范围，请自行保管。
